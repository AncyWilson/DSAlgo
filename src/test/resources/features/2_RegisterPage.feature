...
@TC_Register_01
  ...
  Scenario:  The user is succesfully able to register 
    ...
    When The user enters a valid "username" and "password" and "password confirmation"
      | username     | password  | password confirmation |
      | Nmpy@sdet117_102 | RT56YU@78 | RT56YU@78       |
    Then The user should be redirected to Homepage with the message "New Account Created. You are logged in as Nmpy@sdet117_102"
